...
public function show_car($id)
{
 ...
 ->where(['car_services.service_status'=>$id,'car_services.deleted'=>0,'car_services.due_to_customer'=> $loged_Id])->paginate(10);
...
public function hide_car($id){
  ...
  public function update_Car($id){
    $data['airline']=Airline::where('is_active',1)->get();
        ...
        $data['cars']=CarService::oin('currency','currency.cur_id','=','car_services.cur_id')
