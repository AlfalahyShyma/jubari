...
<tr>
@if($tickets->service_status==1)
<button  formaction="/deleteallticket" type="submit" class="btn btn-danger   float-left m-3 p-2">Delete All Selected</button>
	<button formaction="/sendallticket" type="submit" class="btn  btncolor float-right m-3 p-2">Send All Selected</button>
  @endif       
</tr></tfoot>               
                </table>
