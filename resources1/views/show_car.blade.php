...
<td><?php echo $i;?></td>
  ...
  <a class="btn btncolor" type="button" href="{{ url('/service/update_car/'.$cars->car_id) }}"><i class="fa fa-pencil-alt" aria-hidden="true"></i></a> 
...
<tr>
@if($cars->service_status==1)
<button  formaction="/deleteallcar" type="submit" class="btn btn-danger float-left p-2 m-3">Delete All Selected</button>
	<button formaction="/sendallcar" type="submit" class="btn btncolor float-right p-2 m-3">Send All Selected</button>
  @endif       
</tr></tfoot>   
                </table>
