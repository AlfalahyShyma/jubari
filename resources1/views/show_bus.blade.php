...
<tr>
@if($buss->service_status==1)
<button  formaction="/deleteallbus" type="submit" class="btn btn-danger float-left p-2 m-3">Delete All Selected</button>
	<button formaction="/sendallbus" type="submit" class="btn btncolor float-right p-2 m-3">Send All Selected</button>
  @endif       
</tr>
</tbody>      </tfoot>
                  <?php $i++ ?>
