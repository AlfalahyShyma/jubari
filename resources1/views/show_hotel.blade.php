...
<tr>
@if($hotels->service_status==1)
<button  formaction="/deleteallhotel" type="submit" class="btn btn-danger   float-left p-2 m-3">Delete All Selected</button>
	<button formaction="/sendallhotel" type="submit" class="btn  btncolor float-right p-2 m-3 ">Send All Selected</button>
  @endif       
</tr> </tfoot>             
                </table>
