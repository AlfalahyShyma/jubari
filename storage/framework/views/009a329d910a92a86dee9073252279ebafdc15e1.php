    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="form-group">
                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                      <input onclick="vip<?php echo e($item->cus_id); ?>()" type="checkbox" class="custom-control-input" id="customSwitch<?php echo e($item->cus_id); ?>">
                      <label class="custom-control-label" for="customSwitch<?php echo e($item->cus_id); ?>"></label>
                    </div>
                  </div>
                  <?php elseif($item->vip == 1): ?>
                  <div class="form-group">
                    <div  class="custom-control custom-switch custom-switch-on-success custom-switch-off-danger ">
                      <input onclick="vip<?php echo e($item->cus_id); ?>()" checked type="checkbox" class="custom-control-input" id="customSwitch<?php echo e($item->cus_id); ?>">
                      <label class="custom-control-label" for="customSwitch<?php echo e($item->cus_id); ?>"></label>
                    </div>
                  </div>
<?php endif; ?>  
...
<td style="display:none">
      ...
      <div class="form-group">
                    <div  class="custom-control custom-switch custom-switch-on-success custom-switch-off-danger ">
                      <input onclick="vip<?php echo e($item->cus_id); ?>()" checked type="checkbox" class="custom-control-input" id="customSwitch1<?php echo e($item->cus_id); ?>">
                      <label class="custom-control-label" for="customSwitch1<?php echo e($item->cus_id); ?>"></label>
                    </div>
                  </div>
                  <?php endif; ?>  
...
<?php endif; ?>  
  ...
  <a type="button" class="btn btn-success" href="customer_edit/<?php echo e($item->cus_id); ?>"><i class="fas fa-pencil-alt "></i></a>
  <a type="button" class="btn btn-danger" onclick="deleteitem(<?php echo e($item->cus_id); ?>)" ><i class="fas fa-trash "></i></a>
  <a type="button" class="btn btn-info" onclick="show(<?php echo e($item->cus_id); ?>)"><i class="fas fa-eye "></i></a>
</div>
     <!-- The Modal -->
...
$.ajax({
       ...
       success:function(response){console.log(response);
        document.getElementById('tr<?php echo e($item->cus_id); ?>').style.display ='none';
...
function vip<?php echo e($item->cus_id); ?>() {
  var checkBox<?php echo e($item->cus_id); ?> = document.getElementById("customSwitch<?php echo e($item->cus_id); ?>");
  var checkBox1<?php echo e($item->cus_id); ?> = document.getElementById("customSwitch1<?php echo e($item->cus_id); ?>");

  if (checkBox<?php echo e($item->cus_id); ?>.checked == true){
    $.ajax({
             type:'get',
             url:'/is_vip/'+<?php echo e($item->cus_id); ?>,
             data:{id:<?php echo e($item->cus_id); ?>},
             success:function(response){console.log(response);
            // alert("data saved");
             },
             error:function(error){console.log(error);
    ...
    $.ajax({
             type:'get',
             url:'/no_vip/'+<?php echo e($item->cus_id); ?>,
             data:{id:<?php echo e($item->cus_id); ?>},
             success:function(response){console.log(response);
            // alert("data saved");
             },
...
if (checkBox1<?php echo e($item->cus_id); ?>.checked == true){
    $.ajax({
             type:'get',
             url:'/customer/is_active/'+<?php echo e($item->cus_id); ?>,
             data:{id:<?php echo e($item->cus_id); ?>},
             success:function(response){console.log(response);
            // alert("data saved");
             },
    ...
    $.ajax({
             type:'get',
             url:'/customer/no_active/'+<?php echo e($item->cus_id); ?>,
             data:{id:<?php echo e($item->cus_id); ?>},
             success:function(response){console.log(response);
            // alert("data saved");
             },
...
<?php echo $__env->make('app_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\jubari_travel-trainning\resources\views/customer_display.blade.php ENDPATH**/ ?>