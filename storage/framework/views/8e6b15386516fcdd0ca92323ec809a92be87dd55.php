  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <h4> bill_number</h4>
      ...
      <input type=text hidden=hidden value="<?php echo e($item->uuser_resiver); ?>" class="form-control mt-2 mb-2" id=user_resiver name=user_resiver>
      <input type=text hidden=hidden value="<?php echo e($item->s_num); ?>" class="form-control mt-2 mb-2" id=nummm name=nummm>
      <a  type="button" onclick="send_bill('<?php echo e($item->t_id); ?>',<?php echo e($item->st_id); ?>)" class="btn btn-success" data-dismiss="modal">save</a>
...
function sendremark(){
  ...
  var n=$('#num').val();
  var to=$('#to').val();
  var from=<?php echo e(Auth::user()->id); ?>;
  $.ajax({
             type:'get',
...
<?php echo $__env->make('app_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\jubari_travel-trainning\resources\views/accountant_review.blade.php ENDPATH**/ ?>