  ...
  <div class="dropdown">
    ...
    <div class="dropdown-menu">
      ...
      <?php if(count($data)): ?>
                      ...
                      <a class="dropdown-item" href="/supplierRepo/display_row/<?php echo e($name->s_no); ?>"><?php echo e($name->supplier_name); ?></a>
...
<?php echo $__env->make('app_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\jubari_travel-trainning\resources\views/display_rowRepo.blade.php ENDPATH**/ ?>