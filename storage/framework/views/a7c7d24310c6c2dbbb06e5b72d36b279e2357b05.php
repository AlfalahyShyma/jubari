 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src=<?php echo e(asset('assets/img/logo.png')); ?> alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .9;background-color: white;">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              ?>
               <?php endif; ?>  
               <?php if(Auth::user()->hasRole('sale_manager')): ?>
               <?php
              ...
              ?>
               <?php endif; ?> 
               <?php if(Auth::user()->hasRole('sale_executive')): ?>
               <?php
...
<?php /**PATH C:\wamp\www\jubari_travel-trainning\resources\views/includes/sidebar.blade.php ENDPATH**/ ?>