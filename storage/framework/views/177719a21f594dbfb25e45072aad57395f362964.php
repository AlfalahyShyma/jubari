...
<div class="row login">
     <div class="col-md-6 col-sm-12 logo animated fadeLeft" style="animation-delay:0s;">
           <div class="card-body text-center">
                  <img src="<?php echo e(asset('img/theme/logo.png')); ?>" class="img-fluid">     

           </div>
     </div>
  <div class="col-md-6 col-sm-12 form animated fadeLeft" style="animation-delay:1s;">
  </br>
  <h2 class="text-center" style="color: #3f3a73;font-size: 35px;font-weight: 600;"><span style="    color: #606060;
    ">L</span>ogin <span style="    color: #606060;
    ">S</span>ystem </h2>
  </br>
    <div class="card-body text-center">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <?php if(Route::has('password.request')): ?>
                                    <a class="btn btn-link" style="color: #606060;" href="<?php echo e(route('password.request')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\jubari_travel-trainning\resources\views/auth/login.blade.php ENDPATH**/ ?>